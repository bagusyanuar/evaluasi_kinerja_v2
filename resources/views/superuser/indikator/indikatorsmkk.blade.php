    ...
    <section class="___class_+?0___ mt-content">
        ...
        <div class="mt-4  table-container" style="min-height: 23vh">
            <div class="header-table">
                <div>
                <p class="title-table fw-bold t-primary mb-0">Data Indikator RK SMKK </p>
            </div>
                <div>
                    <form class="d-flex">
                        ...
                        {{-- <a class="btn btn-primary" href="/indikator-smkk"><i class='bx bx-reset'></i></a> --}}
...
@section('script')
    <script>
        var title, idSubIndikatorRksmkk, idIndikatorRksmkk;
        ...
        $(document).on('keypress', '#textNameSub', function (e) {
            ...
            if (e.which === 13) {
                var idIndikatorRksmkk = $(this).data('id-indikator');
                var name = $(this).val();
                var id = $(this).data('id');
                //
                saveSubIndicator(idIndikatorRksmkk, id, name)
            }
        })

        $(document).on('click', '#addSubIndikator', function () {
            $('.trInput').remove();
            var id = $(this).data('id');
        ...
        $(document).on('click', '#editSubIndikator', function () {
            ...
            idSubIndikatorRksmkk = $(this).data('id');
            idIndikatorRksmkk = $(this).data('id-indikator')
            $item.html('' +
                ...
                idSubIndikatorRksmkk + '" data-id-indikator="' + idIndikatorRksmkk +
        ...
        function saveSubIndicator(idIndikatorRksmkk, id, name) {
            var data = {
                '_token': '{{ csrf_token() }}',
                'id': id,
                'name': name,
            ...
            saveDataObject(title + ' Data Sub Indikator', data, window.location.pathname + '/' + idIndikatorRksmkk,
                afterSaveSub)
            return false;
        }
        ...
        function getRksmkkIndicator() {
            var filter = {
                'cari': '{{ request('cari') }}'
            }

            $.get('/indikator-smkk/get-rksmkk', filter, function (data) {
               $('#rowIndikator').empty();
                $.each(data, function (key, value) {
                    ...
                    $('#rowIndikator').append('<div class="col-sm-12  ">\n' +
                        ...
                        '    <a class="bt-success-xsm " data-id="' + value['id'] + '"  id="addSubIndikator"><i class="bx bx-plus" ></i>Tambah Sub</a> \n' +
        ...
        function getSubIndikator(id) {
            $.get('/indikator-smkk/' + id + '/sub', function (data) {
				 $('#tbody' + id).empty();
