    ...
    <section class="container-fluid p-lg-3 p-xl-3">
		...
		<div class="row">
			<div class="col-xl-12 col-lg-12">
				...
				<div class="row">
					<div class="col-12" id="content-komulatif">
                        <div class="card-panel back-panel-2 table-container">
                            <p class="fw-bold t-black">Rekap Komulatif</p>
                            <hr>
                            <div id="result-komulatif">
							<table class="table" style="width:100%">
								<tbody id="tablek">
								<tr class="bg-prim-light"><th style="width:50px" >No</th><th >Uraian</th><th style="min-width: 110px">Nilai</th></tr>
								<tr class="primary-light-text"><td class="primary-light-text">1</td><td class="primary-light-text">Perencanaan terkait K3</td><td style="min-width: 110px" id="comulative_value1"></td></tr>
								<tr class="primary-light-text"><td class="primary-light-text">2</td><td class="primary-light-text">Perencanaan terkait pengelolaan lingkungan</td><td style="min-width: 110px" id="comulative_value2"></td></tr>
								<tr class="primary-light-text"><td class="primary-light-text">3</td><td class="primary-light-text">Perancangan terkait K3</td><td style="min-width: 110px" id="comulative_value3"></td></tr>
								<tr class="primary-light-text"><td class="primary-light-text">4</td><td class="primary-light-text">RKK Kontraktor</td><td style="min-width: 110px"  id="comulative_value4"></td></tr>
								<tr class="primary-light-text"><td class="primary-light-text">5</td><td class="primary-light-text">RKPPL Kontraktor</td><td style="min-width: 110px" id="comulative_value5"></td></tr>
								<tr class="primary-light-text"><td class="primary-light-text">6</td><td class="primary-light-text">RMPK Kontraktor</td><td style="min-width: 110px"  id="comulative_value6"></td></tr>
								<tr class="primary-light-text"><td class="primary-light-text">7</td><td class="primary-light-text">RMLLP Kontraktor</td><td style="min-width: 110px" id="comulative_value7"></td></tr>
								<tr class="primary-light-text"><td class="primary-light-text">8</td><td class="primary-light-text">RKK Konsultan Pengawas</td><td style="min-width: 110px" id="comulative_value8"></td></tr>
								<tr class="primary-light-text"><td class="primary-light-text">9</td><td class="primary-light-text">Program Mutu Konsultan Pengawas</td><td style="min-width: 110px" id="comulative_value9"></td></tr>
								<tr class="primary-light-text"><td class="primary-light-text">10</td><td class="primary-light-text">Pengawasan terkait pengelolaan lingkungan</td><td style="min-width: 110px" id="comulative_value10"></td></tr>
								<tr class="primary-light-text"><td class="primary-light-text">11</td><td class="primary-light-text">Administrasi Teknik Jalan</td><td style="min-width: 110px" id="comulative_value11"></td></tr>
								</tbody>
								</table>
                            </div>
                        </div>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form id="form" onsubmit="return Save()">
                            ...
                            <input id="scoreid" name="scoreid" hidden>
...
@section('script')
	...
	function elTablek() {
		//let response = $.get('/smkk/resultskomulatif?package=' + package_id ) ;
      //        //  let data = response['data']['indicator'];
		//let = response['total'];
            return '<table class="table" style="width:100%">' +
                '<tbody id="table">' +
				'<tr class="bg-prim-light" id="1">' +
                '<th>'+ total +'</th>' +
                '<th >rekap</th>' +
                '<th style="min-width: 110px">File</th>' +
				'<th style="min-width: 110px" >Nilai</th>' +
	...
	async function getKomulatif() {
            let elk = $('#result-komulatif');
			let tbl= 'komulatif';
            try {
              //  elk.empty();
                let response = await $.get('/smkk/resultskomulatif?package=' + package_id ) ;
              //  let data = response['data']['indicator'];
              //  elk.append(elTablek());
               // let tablek = $('#tablek');
			   //let total = 100;
               setComulative(response['data']);  
			   //  console.log(response)
            } catch (e) {
                console.log(e);
            }
	 ...
	 function setComulative(data) {
            $('#comulative_value1').html(data.total1)
            $('#comulative_value2').html(data.total2)
            $('#comulative_value3').html(data.total3)
            $('#comulative_value4').html(data.total4)
            $('#comulative_value5').html(data.total5)
            $('#comulative_value6').html(data.total6)
            $('#comulative_value7').html(data.total7)
            $('#comulative_value8').html(data.total8)
            $('#comulative_value9').html(data.total9)
            $('#comulative_value10').html(data.total10)
            $('#comulative_value11').html(data.total11)
        }
	...
	async function setScoreAtj(sub, value) {
	 ...
	 $(document).ready(function () {
		  console.log(roles)
			...
			getScoreRmpkpm();
			getScoreRmllp(); 
			$('#content-komulatif').removeClass('d-block');
			...
			$('#content-komulatif').addClass('d-none');
			$('#content-detail-nilai').addClass('d-block');
			...
			$('#penilaian-title').html('RANCANGAN KONSEPTUAL SMKK');
			$('#penilaian-title2').html('RENCANA KESELEMATAN KONSTRUKSI KONSULTANSI KONSTRUKSI PENGAWASAN (RKK Konsultan)');
			$('#penilaian-title3').html('RENCANA KESELEMATAN KONSTRUKSI PEKERJAAN KONSTRUKSI (RKK Kontraktor)');	
			$('#penilaian-title4').html('RENCANA MUTU PEKERJAAN KONSTRUKSI (RMPK) dan PROGRAM MUTU');	
            ...
            $('.card-user').on('click', function () {
                ...
                if (this.dataset.roles == 'smkk') {
                    ...
                    getKomulatif();
					$('#content-komulatif').removeClass('d-none');
					$('#content-detail-nilai').removeClass('d-block');
					$('#content-detail-nilai2').removeClass('d-block');
					$('#content-detail-nilai3').removeClass('d-block');
					$('#content-detail-nilai4').removeClass('d-block');
					$('#content-detail-nilai5').removeClass('d-block');
					$('#content-komulatif').addClass('d-block');
					$('#content-detail-nilai').addClass('d-none');
					$('#content-detail-nilai2').addClass('d-none');
					$('#content-detail-nilai3').addClass('d-none');
					$('#content-detail-nilai4').addClass('d-none');
					$('#content-detail-nilai5').addClass('d-none');
					$('#penilaian-title').html('KOMULATIF');
                    //getLastUpdate(index);
                }
